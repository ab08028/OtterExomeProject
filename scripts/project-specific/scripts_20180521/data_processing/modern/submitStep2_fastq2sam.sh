...
SCRIPTDIR=/u/home/j/jarobins/project-rwayne/utils/scripts/picard/FastqToSam
...
$QSUB -N fq2sam${c} $SCRIPTDIR/$scriptname $fileR1 $fileR2 $header_FastqToSam.bam ${header}_1a ${header} Lib1 $UNIT $platform $seqCenter
