...
slimModel=1D.2Epoch.70gen.500dip # model SLIM was simulated under 
...
scripts='1D.1Epoch.dadi.py 1D.2Epoch.dadi.py 1D.2Epoch.newStartValues.dadi.py 1D.2Epoch.LargeFoldChange.dadi.py'
#scripts='1D.2Epoch.newStartValues.dadi.py'
