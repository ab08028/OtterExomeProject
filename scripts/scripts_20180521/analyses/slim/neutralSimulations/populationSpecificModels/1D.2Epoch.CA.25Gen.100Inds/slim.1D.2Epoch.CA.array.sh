...
#$ -M ab08028
#$ -t 1-60
####### this is the simplified model I used for all my CA cds simulations ######
...
slimscript=CA.1D.2Epoch.25Gen.100Inds.slim # specific slim script
...
nanc=3500 # ancestral size from dadi for CA, simplified
nu=100 #
