...
ss=10 # in diploids # will depend on population, note you can find these in projectionValues.txt file
...
# variables:
nanc=4834
nu=114 # contraction size 
tcontract=10 # contraction duration before you sample
