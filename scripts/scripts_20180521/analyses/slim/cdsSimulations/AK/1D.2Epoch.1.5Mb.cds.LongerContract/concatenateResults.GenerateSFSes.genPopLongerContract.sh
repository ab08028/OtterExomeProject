...
rundate=20190607 # set of simulations you're interested in (if is across different rundates you can list popsModelsRundates explicitly)
...
popMods="AK/1D.2Epoch.1.5Mb.cds.LongerContract"
