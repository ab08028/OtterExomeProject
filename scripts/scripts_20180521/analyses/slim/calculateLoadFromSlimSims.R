...
popModDates=c("AK/1D.2Epoch.1.5Mb.cds/20190424/","AL/1D.2Epoch.1.5Mb.cds/20190424/","genericPop.LongerContract/1D.2Epoch.1.5Mb.cds/20190607") # AK and AL have dadi parameters, genericPop has parameters based on AK MLE grid that is fur-trade relevant. ### need to come up with better classification system for this. 
#reps=c(seq(1,23))
