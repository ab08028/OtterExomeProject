...
# updating script to work on downsampled vcfs:
# snp7 includes admixed individuals and relatives; snp9 has excluded all admixed individuals identified based on snp7
# both have been downsampled to half the number of COM samples and remove weird COM samples identified by sergio's NJ tree
