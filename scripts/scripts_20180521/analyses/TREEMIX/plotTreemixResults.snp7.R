...
data.dir=paste("/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/results/analysisResults/TREEMIX/",genotypeDate,"/snp7/goodParams-USETHESE/",sep="")
...
markers=c("sepCA-BAJ","noBAJA")
for(marker in markers){
models=list.files(data.dir,pattern = marker)
# pop file for models incld BAJA:
pops=paste("/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/results/analysisResults/TREEMIX/20181119/poporder.",marker,".noFerret.txt",sep="") # for plotting residuals
