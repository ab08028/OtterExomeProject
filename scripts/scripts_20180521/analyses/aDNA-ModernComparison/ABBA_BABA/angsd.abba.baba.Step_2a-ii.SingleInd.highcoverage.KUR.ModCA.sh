...
todaysdate=`date +%Y%m%d`'-highcov-singleInd-minInd-modCA-AK-KUR'
#### ANGSD v 0.923 ####
...
mfurBamList=$bamListDir/angsd.bamList.mappedtoMfurfullpaths.HighCovPlusADNAOnly.InPopOrder.3inds.ModCA.AK.KUR.txt
