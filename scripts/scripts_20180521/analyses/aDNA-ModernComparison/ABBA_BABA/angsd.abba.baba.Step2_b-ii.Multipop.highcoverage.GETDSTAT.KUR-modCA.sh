...
######### dirs and files ###########
abbadate="20191230-highcov-singleInd-minInd-modCA-AK-KUR" # with min ind filter
...
IDfile=angsd.bamList.mappedtoMfurfullpaths.HighCovPlusADNAOnly.InPopOrder.3inds.ModCA.AK.KUR.txt
