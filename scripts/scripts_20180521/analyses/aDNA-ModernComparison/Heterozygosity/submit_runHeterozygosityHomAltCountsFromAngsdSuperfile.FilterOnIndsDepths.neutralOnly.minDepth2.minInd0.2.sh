...
minDepthCutoff=2 # sites that are < this threshold will not be counted toward an individuals heterozygosity
# want to try a range minInds
minIndsOptions="0 2" # trying new options # options for minInds 
