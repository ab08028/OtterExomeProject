...
script=$scriptDir/analyses/aDNA-ModernComparison/Heterozygosity/parseBeagleSuperfile.CalculateHeterozygosity.ManyFilters.HARDCALLSONLY.py # this does actual hard calls past GP threshold
# rather than adding GPs together! should down weight hets maybe?
