...
states=c("1e-6.snpsOnly", "1e-6.snpsOnly.transversionsOnly")
...
for(ref in refs){
  ...
  for(state in states){
    ...
    p12
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".PC1.PC2.pdf",sep=""),p12,device="pdf",height=7, width=10)
    ...
    p13 <- ggplot(PC, aes_string(x=x_axis, y=y_axis)) + 
      ...
      scale_shape_manual(values=c(8,16,1))
    p13
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".PC1.PC3.pdf",sep=""),p13,device="pdf",height=7, width=10)
    ...
    p23 <- ggplot(PC, aes_string(x=x_axis, y=y_axis)) + 
      ...
      scale_shape_manual(values=c(8,16,1))
    p23
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".PC2.PC3.pdf",sep=""),p23,device="pdf",height=7, width=10)
  }
}

################ Downsampled Inds only ################
states=c("1e-6.snpsOnly.downSampOnly.minInd.5", "1e-6.snpsOnly.downSampOnly.minInd.5.transversionsOnly")
refs=c("Elut","Mfur") # set what reference you mapped to 
# see below for downsampled inds only 
# with and without transversions
for(ref in refs){
  ...
  for(state in states){
    ...
    p12 <- ggplot(PC, aes_string(x=x_axis, y=y_axis)) + 
      ...
      scale_shape_manual(values=c(8,16,1))
    p12
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".LowCovOnly.PC1.PC2.pdf",sep=""),p12,device="pdf",height=7, width=10)
    ...
    p13 <- ggplot(PC, aes_string(x=x_axis, y=y_axis)) + 
      ...
      scale_shape_manual(values=c(8,16,1))
    p13
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".LowCovOnly.PC1.PC3.pdf",sep=""),p13,device="pdf",height=7, width=10)
    ...
    p23 <- ggplot(PC, aes_string(x=x_axis, y=y_axis)) + 
      ...
      scale_shape_manual(values=c(8,16,1))
    p23
    ggsave(paste(data.dir,"PCA.mappedTo",ref,".",state,".LowCovOnly.PC2.PC3.pdf",sep=""),p23,device="pdf",height=7, width=10)
  }
}
