...
bedtools intersect -b $outdir/modernDataGATK_Freqs/${output}.0based.bed -a $outdir/$countsdir/${basename}.counts.0based.bed.gz -wa -wb >> $combodir/${pop}.${basename}.ancient.counts.freqsFromModernGATK.superfile.0based.bed
