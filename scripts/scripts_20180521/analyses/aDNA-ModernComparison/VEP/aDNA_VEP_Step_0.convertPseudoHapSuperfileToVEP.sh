...
do
indir=$hapDir/$angsdDate # location of your posterior probs
outdir=$wd/VEP/pseudoHaps/$angsdDate
mkdir -p $outdir
...
cdsSuperfile=${basename}.pseudoHaps.superfile.cdsOnly.0based.bed.gz
