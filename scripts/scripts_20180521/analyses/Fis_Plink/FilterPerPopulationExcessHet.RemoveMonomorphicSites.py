...
inVCF.seek(0)
maxHetFilter=0.75
outfile=open("/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/troubleshooting/troubleshootFis/testOut.maxHetFilterPerPop.0.75.FilterOutMonomorphic.vcf","w")
