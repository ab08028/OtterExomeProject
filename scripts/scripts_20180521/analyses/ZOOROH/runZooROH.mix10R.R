...
#load(paste(out.dir,pop,".ZooROH.Results.RData",sep="")) ## this works!!! So don't have to run everything above this once you've done it once
...
zooplot_partitioning(list(pop=results), ylim = c(0,0.5), nonhbd = FALSE)
