...
model=dadiModel3.BothContractions
mkdir -p ${model}
for j in {1..6}
do
...
./macs 2 30000000 -t 0.00015552 -r 0.00018 -s $SEED -eN 0.0 0.06 -eN 0.0025 0.4 -eN 0.06 1  > $outdir/group_${j}_block_${i}.${model}.macsFormat.OutputFile.${rundate}.txt
