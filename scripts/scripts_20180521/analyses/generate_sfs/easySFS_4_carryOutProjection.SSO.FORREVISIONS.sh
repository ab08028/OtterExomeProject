...
outdir=/u/flashscratch/a/ab08028/captures/analyses/SFS/revisions/$genotypeDate/easySFS/neutral/projection-${todaysdate}-hetFilter-${perPopHetFilter}
mkdir -p $outdir
