...
new.fsc.format.dir=paste(data.dir,"fastsimcoal2-1D-plusMonomorphic/") # where you'll put the new sfses that have monomorphic sites added in
dir.create(new.fsc.format.dir) 
dadi.format.dir = paste(data.dir,"dadi/",sep="")
new.dadi.format.dir=paste(data.dir,"dadi-1D-plusMonomorphic/") # where you'll put the new sfses that have monomorphic sites added in
