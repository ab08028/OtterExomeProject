#! /bin/bash
#$ -cwd
#$ -l h_rt=2:00:00,h_data=8G,highp
#$ -N easySFSPreview
...
popFile=/u/flashscratch/a/ab08028/captures/samples/COM.rmWeirdIndsFromSergio.txt # this doesn't have baja or admixed individuals; has COM split into BER and MED
...
#( you are here )
$easySFS -i $vcfdir/${vcf} -p $popFile --preview -a -v > $outdir/neutral.snp_9b.easySFS.projPreview.rmWeirdCOM.txt
