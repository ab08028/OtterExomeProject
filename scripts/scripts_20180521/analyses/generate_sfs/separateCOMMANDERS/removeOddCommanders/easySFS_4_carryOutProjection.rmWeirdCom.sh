...
popFile=/u/flashscratch/a/ab08028/captures/samples/COM.rmWeirdIndsFromSergio.txt
...
populations="COM"
projections="30" # haploids; updated these values on 20181220
...
mkdir -p $outdir
#python $scriptdir/getMonomorphicProjectionCounts.py --vcf $vcfdir/cdsVCFs/${cdsVCF} --popMap $popFile --proj $projections --popIDs $populations --outdir $outdir
