...
# popMap="/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/information/samples/easySFSPopMapFiles/samplesPop.Headers.forEasySFS.2.goingtoModifyFor20181119.txt" ### not final version of this!!!!! <--- but use for now for testing. 
...
def count_PassingMonomorphicSites(pops,projDict,VCF):
    ...
    for line0 in inVCF:
        ...
        if "0/1" in allCalls or "1/0" in allCalls or "1|0" in allCalls or "0|1" in allCalls or "1|1" in allCalls or "1/1" in allCalls:
            ...
            for population in ["CA"]: # pops.keys(): # go through each population 
