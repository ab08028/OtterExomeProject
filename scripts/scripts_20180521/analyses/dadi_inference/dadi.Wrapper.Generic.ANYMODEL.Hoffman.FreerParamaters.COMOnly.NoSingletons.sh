...
sfssuffix=plusMonomorphic.MASKED.SINGLETONS.sfs
...
scripts='1D.1Epoch.dadi.py 1D.2Epoch.dadi.py 1D.1Bottleneck.TB20gen.dadi.py 1D.2Bottleneck.dadi.py 1D.1Bottleneck.TB.005.gen.TRec.005.gen.dadi.py'
