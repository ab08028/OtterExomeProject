...
modelName="1D.4Epoch.fixedParams"
...
def sandbox(params, ns, pts): 
    ...
    phi = Integration.one_pop(phi, xx, 0.0005, 0.005)  # contraction  2 -fix at 20 inds for 4 gen
    # no recovery in between
    fs = Spectrum.from_phi(phi, ns, (xx,)) 
    return fs
param_names=("nuBOT","nuRec")
...
p0 = [0.25,1] # initial parameters guessing that bneck is 1000/4000 and recovery is 4000/4000 and contraction is 30/4000


func=sandbox # set the function
