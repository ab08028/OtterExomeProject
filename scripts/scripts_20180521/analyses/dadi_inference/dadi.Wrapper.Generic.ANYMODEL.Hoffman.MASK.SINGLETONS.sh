...
sfssuffix=plusMonomorphic.SINGLETONS.MASKED.sfs
...
scripts='1D.1Epoch.dadi.py 1D.2Epoch.dadi.py' # just this one for now
#scripts='1D.Decline.dadi.py'
for pop in CA AK AL KUR BER MED # skipping COM for now
do
