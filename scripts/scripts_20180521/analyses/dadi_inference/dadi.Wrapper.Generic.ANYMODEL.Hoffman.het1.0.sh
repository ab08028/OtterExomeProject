...
sfsDate=20200106 # projection with 1.0 het filter
hetFilter=1
...
for pop in CA AK AL KUR COM # skipping med/ber/com for now
do
...
outdir=$dadidir/$genotypeDate/$pop/inference_${todaysdate}-hetFilter1.0/$model/
mkdir -p $outdir
