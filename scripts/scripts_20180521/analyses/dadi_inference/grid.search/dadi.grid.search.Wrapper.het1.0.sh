...
## indir is the sfses that had the het=1.0 max filter
indir=/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/results/datafiles/SFS/20181119/easySFS_projection/neutral/projection-20200106-hetFilter-1/dadi-plusMonomorphic
...
outdir=/Users/annabelbeichman/Documents/UCLA/Otters/OtterExomeProject/results/analysisResults/dadi_inference/$genotypeDate/grid.search/het1.0Filter/$pop
mkdir -p $outdir
...
############## COM-- adding 2 epoch too; skipping 3epoch for now ################
pop=COM
