...
modelName="1D.3Epoch.FixedTimes"
...
TB_fixed=0.002 # fixed duration of bneck (~1741-1911) approx 20 gens
TF_fixed=0.001 # fixed duration of recovery approx 10 gens (~1911-1980)
...
for params in grid:
    #print(params)
    output=provideParams_3EpochModel(fs=fs,nuB=params['nuB'],nuF=params['nuF'],TB=TB_fixed,TF=TF_fixed)
