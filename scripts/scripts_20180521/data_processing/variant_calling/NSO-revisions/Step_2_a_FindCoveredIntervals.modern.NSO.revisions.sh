...
REFPREFIX=northern_sea_otter_genome
REFSHORTCODE=NSO

outdir=$wd/coveredIntervals/$REFSHORTCODE # this is new -- making a ref genome specific dir here (will need to adjust in hap caller script too)
mkdir -p $outdir
