...
# script to run: 
scriptname=Step_2_a_FindCoveredIntervals.modern.justBedConversion.sh # change this to final script name!! 
# 
# file locations:
SCRATCH=/u/flashscratch/a/ab08028
wd=$SCRATCH/captures
headers=$wd/samples/modernSamples.plus.capture_02.txt # all Elut samples, modern, ancient and blank
