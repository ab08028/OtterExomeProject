...
mkdir $outdir
outfile=$outdir/plmx.aDNA.summary.stats.screening.mtGenome.txt
REF=elut_kenyoni_ref_ASM228890v2_chrMT # northern sea otter mtGenome # note that you'll collect ALL ref genomes for most stats; you're
