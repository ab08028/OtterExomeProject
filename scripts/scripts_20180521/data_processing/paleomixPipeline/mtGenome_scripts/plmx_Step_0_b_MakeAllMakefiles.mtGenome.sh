...
mkdir -p $makefileDir/ancientMakefiles-mtGenome
...
######## 20180730: mt DNA isn't damaged enough to rescale; just want to plot, not rescale
sed -i'' 's/mapDamage: rescale/mapDamage: plot/g' $newMake
# clear variables
newMake=''
done
