...
wd=$SCRATCH/captures
makefileDir=$scriptDir/makefiles/modernMakefiles-withIndelR-toCompareWithAncient
#headers=$wd/samples/modern.SamplesToCompareToADNA.txt # 3 CA and 3 AK samples 
headers=$wd/samples/modern.headers.redo.txt
# outdirectory:
outdir=$wd/paleomix/fullProcessing
mkdir -p $outdir
# job info: 
...
do
errorLocation=/u/flashscratch/a/ab08028/captures/reports/paleomix/fullProcessing/${header} # report location
