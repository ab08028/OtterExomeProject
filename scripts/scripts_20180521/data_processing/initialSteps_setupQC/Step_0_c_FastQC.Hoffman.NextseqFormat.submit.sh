...
# scripts:
scriptDir=$gitDir/scripts/scripts_20180521/data_processing/initialSteps_setupQC
# script to run: 
scriptname=Step_0_c_FastQC.Hoffman.NextseqFormat.sh # change this to final script name!! 
# 
# file locations:
SCRATCH=/u/flashscratch/a/ab08028
wd=$SCRATCH/captures
#headers=$wd/samples/allElutSamples.txt # all Elut samples, modern, ancient and blank
# 20181102: Baja samples + dogs (note UCLADOG wont have four lanes)
headers=$wd/samples/bajaCaptures.plusDogs.txt
