...
todaysdate="20191212-highcov-AFprior-MajorMinor4-plusCOM-KUR-AL-RedoneToReplaceDeletedFiles-TryingWithMinMafForMfur"
#### ANGSD v 0.923 ####
...
-SNP_pval $snpCutoff \
-rmTrans 1 \
-minMaf 0.01 # adding this to exclude monomorphic fixed sites
