...
neutAngsd=$coordsDir/bedCoords/$neutBed > $coordsDir/angsd-format/${neutBed%.bed}.angsdFmt.txt

realSFS $SFSdir/$todaysdate/perIndividual/${label}.mappedTo${refPrefix}.allSites.TransversionsOnly.saf.idx -rf $neutAngsd > $SFSdir/$todaysdate/perIndividual/${label}.mappedTo${refPrefix}.allSites.TransversionsOnly.saf.SFS.NEUTRAL.txt
realSFS $SFSdir/$todaysdate/perIndividual/${label}.mappedTo${refPrefix}.allSites.saf.idx $neutAngsd > $SFSdir/$todaysdate/perIndividual/${label}.mappedTo${refPrefix}.allSites.saf.SFS.NEUTRAL.txt
