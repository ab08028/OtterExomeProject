...
todaysdate="20190523-lowcov-minInd"
...
echo "THIS USES LOW COVERAGE MODERN + ANCIENT ONLY and sets MinInd to be $minInd " > $GLdir/$todaysdate/LOWCOVERAGEONLY.txt
