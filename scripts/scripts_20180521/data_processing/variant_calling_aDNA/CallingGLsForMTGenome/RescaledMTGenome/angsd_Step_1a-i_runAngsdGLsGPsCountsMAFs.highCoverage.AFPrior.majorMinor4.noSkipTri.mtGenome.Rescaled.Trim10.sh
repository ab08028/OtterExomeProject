...
trimValue=10 # set value you want to trim from either end of read (looking at mapdamage plots)
posterior=1 # setting for angsd -doPost : 1 for using allele frequencies as prior, 2 for using a uniform prior 
todaysdate=`date +%Y%m%d`'-highcov-AFprior-MajorMinor4-mtGenomeOnly-Rescaled-T10'
...
elutBamList=$scriptDir/bamLists/mtGenomes.RESCALED.20191207.txt
