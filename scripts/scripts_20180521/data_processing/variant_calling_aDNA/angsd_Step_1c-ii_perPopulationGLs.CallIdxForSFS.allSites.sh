...
-uniqueOnly 1 \
-doMaf 2 \
-out $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites \
-remove_bads 1 \
-C 50 
...
-ref $mfurRef \
-fai ${mfurRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites.glf.gz \
-out $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.TransversionsOnly \
-nInd $nInd
...
-fai ${mfurRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites.glf.gz \
-out $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites \
-nInd $nInd
...
-uniqueOnly 1 \
-doMaf 2 \
-out $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.allSites \
-remove_bads 1 \
-C 50 
# removed : -SNP_pval 1e-6 \
...
-ref $elutRef \
-fai ${elutRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.allSites.glf.gz \
-out $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.TransversionsOnly \
-nInd $nInd
...
-fai ${elutRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.allSites.glf.gz \
-out $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites \
-nInd $nInd


# note here nInd is 3!! not 15!!!

realSFS $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.TransversionsOnly.saf.idx > $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.TransversionsOnly.saf.SFS.txt
realSFS $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.saf.idx > $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.saf.SFS.txt
