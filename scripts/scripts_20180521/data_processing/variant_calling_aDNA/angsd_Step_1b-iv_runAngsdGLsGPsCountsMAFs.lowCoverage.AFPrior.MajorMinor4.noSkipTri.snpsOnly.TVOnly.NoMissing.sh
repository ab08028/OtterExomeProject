...
############# snps only; transversions only; no missing data  ############
...
snpCutoff=1e-06
minInd=9
todaysdate=`date +%Y%m%d`'-lowcov-AFprior-MajorMinor4-noMissing'
...
-out $outdir/angsdOut.mappedTo${spp}.${snpCutoff}.snpsOnly.TransvOnly.noMiss \
-doGlf 2 \
