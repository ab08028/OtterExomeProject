...
######### Step 1 a: call GLs and GPs, counts and mafs using ANGSD based on downsampled modern + aDNA mapped to elut/mfur **using a uniform prior for GPS** ######
...
todaysdate=`date +%Y%m%d`'-lowcov-UNIFprior'
