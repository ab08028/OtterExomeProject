...
-doGlf 1 \
-doMaf 2 \
-out $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters
...
-ref $mfurRef \
-fai ${mfurRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.glf.gz \
-out $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.TransversionsOnly \
-nInd $nInd
...
-fai ${mfurRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.glf.gz \
-out $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters \
-nInd $nInd


# note here nInd is 3!! not 15!!!

realSFS $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.TransversionsOnly.saf.idx > $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.TransversionsOnly.saf.SFS.txt
realSFS $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.saf.idx > $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.allSites.ZeroFilters.saf.SFS.txt
...
-doGlf 1 \
-doMaf 2 \
-out $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters
# removed : -SNP_pval 1e-6 \
...
-ref $elutRef \
-fai ${elutRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.glf.gz \
-out $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.TransversionsOnly \
-nInd $nInd
...
-ref $elutRef \
-fai ${elutRef}.fai \
-glf $GLdir/$todaysdate/perPopulation/${elutBamList%.bamList.*}.mappedToElut.ZeroFilters.allSites.glf.gz \
-out $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.ZeroFilters.allSites \
-nInd $nInd


# note here nInd is 3!! not 15!!!

realSFS $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.TransversionsOnly.saf.idx > $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.TransversionsOnly.saf.SFS.txt
realSFS $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.saf.idx > $SFSdir/$todaysdate/${elutBamList%.bamList.*}.mappedToElut.allSites.ZeroFilters.saf.SFS.txt
