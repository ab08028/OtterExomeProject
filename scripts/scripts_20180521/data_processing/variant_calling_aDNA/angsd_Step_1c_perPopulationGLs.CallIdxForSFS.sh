...
realSFS $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.${snpCutoff}.snpsOnly.saf.idx > $SFSdir/$todaysdate/${mfurBamList%.bamList.*}.mappedToMfur.${snpCutoff}.snpsOnly.saf.SFS.txt
