...
todaysdate=`date +%Y%m%d`'-ORs-pseudohaps'
...
elutBamList=$scriptDir/bamLists/Oregon.Only.MappedToElut.txt  # list of bam files mapped to sea otter, including downsampled AND non-downsampled
mfurBamList=$scriptDir/bamLists/Oregon.Only.MappedToMfur.txt   # list of bam files mapped to ferret, including downsampled AND non-downsampled
