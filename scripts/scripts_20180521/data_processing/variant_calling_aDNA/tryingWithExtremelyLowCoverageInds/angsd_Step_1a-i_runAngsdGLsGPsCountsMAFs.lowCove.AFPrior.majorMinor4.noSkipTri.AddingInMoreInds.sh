...
todaysdate=`date +%Y%m%d`'-lowcov-AFprior-MajorMinor4-IncludesMoreInds-notAllIndelRealignedYet'
...
### list of bam files to include: low coverage modern + aDNA:
