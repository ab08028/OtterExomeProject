...
snpCutoff=1e-06
minInd=8 # adding this in just for Oregon analysis
...
elutBamList=$scriptDir/bamLists/angsd.bamList.mappedtoElutfullpaths.HighCovPlusADNAOnly.PLUSEXTRAADNA.notIndelRealYet.JustOR.txt
