...
todaysdate=`date +%Y%m%d`'-highcov-AFprior-MajorMinor4-IncludesMoreInds-notAllIndelRealignedYet'
...
elutBamList=$scriptDir/bamLists/angsd.bamList.mappedtoElutfullpaths.HighCovPlusADNAOnly.PLUSEXTRAADNA.notIndelRealYet.txt
# 20191202: list of bam files mapped to sea otter, including extremely low coverage aDNA with min. 5000 reads uniquely mapping (includes two Oregon samples) that haven't yet gone through indel realignment (full processing) since I just want to do this as an initial screen
