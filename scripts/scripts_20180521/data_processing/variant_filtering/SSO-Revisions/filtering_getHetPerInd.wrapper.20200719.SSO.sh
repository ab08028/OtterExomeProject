...
vcfs='neutral_and_cds_VCFs/neutralVCFs/neutral.all_9_maxHetFilter_0.75_rmRelatives_rmAdmixed_passingBespoke_maxNoCallFrac_1.0_rmBadIndividuals_passingFilters_raw_variants.vcf.gz'
for vcf in $vcfs
do
