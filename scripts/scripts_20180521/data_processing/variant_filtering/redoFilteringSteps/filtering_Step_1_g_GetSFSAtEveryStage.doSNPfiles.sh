...
# eventually
for vcfFile in 'snp_2_Filter_TrimAlt_'${infile} 'snp_3_Flagged_GQ_DP_GaTKHF_cluster_'${infile} 'snp_4_Filtered_GQ_DP_GaTKHF_cluster_'${infile} 'snp_8_rmRelativesAdmixed_maxNoCallFrac_0.2_passingBespoke_passingAllFilters_postMerge_'${infile}
