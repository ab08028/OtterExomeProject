...
module load R
git.dir=/u/home/a/ab08028/klohmueldata/annabel_data/OtterExomeProject/

script.dir=$git.dir/scripts/scripts_20180521/data_processing/variant_filtering/
...
for vcf in $vcfs2gds
do
Rscript $script.dir/$script --vcf $vcf --outdir $outdir
done
