...
${vcfdir}/populationVCFs/${pop}_'all_9_rmAllHet_rmRelativesAdmixed_passingAllFilters_allCalled.vcf.gz' \
...
$bgzip ${vcfdir}/populationVCFs/${pop}_'all_9_rmAllHet_rmRelativesAdmixed_passingAllFilters_allCalled.vcf.gz'
