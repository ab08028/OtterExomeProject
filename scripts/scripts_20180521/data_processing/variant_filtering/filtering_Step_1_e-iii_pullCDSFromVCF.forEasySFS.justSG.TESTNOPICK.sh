...
-o $outdir/TEST.NO.PICK.20190806.vep_cds_${snpVCF%.gz}
#--pick
...
--input_file $outdir/TEST.NO.PICK.20190806.vep_cds_${snpVCF%.gz} \
--output_file $outdir/TEST.NO.PICK.20190806.stopgained_vep_cds_${snpVCF%.gz}  \
--force_overwrite
